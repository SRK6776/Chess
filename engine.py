...
class GameState:
    ...
    def make_move(self, move):
        ...
        self.castle_rights_log.append(CastleRights(self.current_castling_rights.wks, self.current_castling_rights.wqs, self.current_castling_rights.bks, self.current_castling_rights.bqs))
    ...
    def undo_move(self):
        ...
        self.current_castling_rights = CastleRights(new_rights.wks, new_rights.wqs, new_rights.bks, new_rights.bqs)
    ...
    def get_valid_moves(self):
        ...
        # Add castling moves (only generated if not in check to prevent loop)
